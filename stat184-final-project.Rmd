...
GlyphReady %>%
  ...
  ylab("Average Grade")
```
This plot shows the relationship between average grade, highest level of parent education, and average daily alcohol consumption levels. It shows that on average, there is a positive relationship between parent education level and a student's average grades. It also shows that students with high levels of alcohol consumption tend to have lower average grades than those with low levels. The jittering shows that the average grades are widely spread out and there are not large clumps of similar grades.
